...
values."
  (setq-default
   ...
   '(
     ...
     ;; TODO(Oleh): enable again, when this is merged from develop
     ;; pdf-tools
     )
...
in `dotspacemacs/user-config'."
  (setq-default
   ...
   ;; Shell
   '(shell :variables
           shell-default-shell 'ascii-term
...
layers configuration. You are free to put any user code."
  ...
  (spacemacs/set-leader-keys-for-major-mode 'haskell-mode "r" 'hare-refactor-rename)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ahs-plugin-whole-buffer-face ((t (:background "dark slate blue" :foreground "gray")))))
